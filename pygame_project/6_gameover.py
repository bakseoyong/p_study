...
# 게임 종료 메시지 / Time Out(시간 초과), Mission Complete*성공), Game Over (캐릭터 공에 맞음)
...
while running:
    ...
    # 무기 위치 조정
    # 초기 100, 200 이라면, y좌표는 180 160 140 .. 으로 스피드만큼 빼줘야 한다.
    # 500, 200 이라면, y 좌표는 180 160 140 .. 으로
